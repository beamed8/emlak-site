    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container max-w-8xl mx-auto px-5 2xl:px-0 relative z-10">
        <div className="grid grid-cols-12 items-center gap-10">
          ...
          <div className="lg:col-span-6 col-span-12">
            <Link href="/properties?kategori=Malikaneler" className="block">
          ...
          <div className="lg:col-span-6 col-span-12">
            <Link href="/properties?kategori=Kafeler" className="block">
              <div className="relative rounded-2xl overflow-hidden group cursor-pointer">
                <Image
          ...
          <div className="lg:col-span-3 col-span-6">
            <Link href="/properties?kategori=Oteller" className="block">
              <div className="relative rounded-2xl overflow-hidden group cursor-pointer">
                <Image
          ...
          <div className="lg:col-span-3 col-span-6">
            <Link href="/properties?kategori=Köşkler" className="block">
              <div className="relative rounded-2xl overflow-hidden group cursor-pointer">
                <Image
